...
angular.module('emission.main.goals.goalhome',['emission.services', 'ngSanitize', 'ngAnimate', 'angularLocalStorage'])

.controller('GoalsHomeCtrl', function(CommHelper, $state, $ionicLoading, $scope, $rootScope, $ionicModal, 
